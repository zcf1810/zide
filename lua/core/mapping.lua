...
global_mapping.register = function(new_map)
    ...
    if next(plugins_groups) ~= nil and plugins_groups['default'] ~= nil and plugins_groups['default']['which_key'] and plugins_groups['default']['which_key']['disable'] == false and #key_list > 1 and new_map.mode == 'n' then
        local prefix = key_list[1]
        if #key_list > 1 then
...
global_mapping.setup = function()
    ...
    if next(plugins_groups) ~= nil and plugins_groups['default'] ~= nil and  plugins_config.plugins_groups['default']['which_key'] and plugins_config.plugins_groups['default']['which_key']['disable'] == false then
